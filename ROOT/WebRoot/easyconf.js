var easyconf = new Object({
    ...
    apps:{
        INIT:"http://localhost/servlet/Init",
        LIST:"http://localhost/servlet/Search",
        DETAIL:"detail",
        DELETE:"delete",
        UPDATE:"update",
        INSERT:"http://localhost/servlet/Insert",
        RANGE:"http://localhost/servlet/Range"
    },
    ...
    search:function(http, query) {
        ...
        ec.lock();
        http.get(ec.apps.LIST, {params:{table:ec.table, data:ec.list2str(data), query:ec.dict2str(query),begin:0,count:10}}).success(
//        url = "./list.json";
...
//        http.get(ec.apps.LIST, {params:{table:ec.table, data:ec.list2str(data), query:ec.dict2str(ec.lastquery)}}).success(
    ...
    commit:function(http) {
        ...
        ec.lock();
        http.get(domain, config).success(
            function(response) {
